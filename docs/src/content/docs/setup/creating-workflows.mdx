...
1. **Start your coding agent**. Start [VSCode Agent Mode](https://code.visualstudio.com/docs/copilot/agents/overview) or your coding agent in your repository

2. **Create an agentic workflow**. Enter the following prompt:
...
Optionally you can also install further agent support for workflow creation by entering this into your coding agent:
